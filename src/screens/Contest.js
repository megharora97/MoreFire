...
import TextJson from '../../src/Component/TextJson';
...
class Contest extends React.PureComponent {
    ...
    renderDart = ({ item, index }) => {
        ...
        return (
            <View style={{ flex: 1, flexDirection: 'row', borderWidth: 0.2, borderColor: Colors.Grey94 }}>
            ...
            <SafeAreaView style={Styles().container}>
                ...
                <ScrollView style={{ flex: 1, width: '100%' }} keyboardShouldPersistTaps='handled' showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false}>
                    <View>
                        ...
                        {this.applyFilter(this.props.Data.Matches).map((match, index) => {
                        ...
                        {this.remainingFilter(this.props.Data.Matches).map((match, index) => {
